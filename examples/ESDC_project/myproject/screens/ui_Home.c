...
void ui_Home_screen_init(void)
{
    ...
    lv_obj_set_x(ui_Hour, -45);
    lv_obj_set_y(ui_Hour, -69);
    ...
    lv_obj_set_x(ui_Minute, 35);
    lv_obj_set_y(ui_Minute, 8);
    ...
    lv_obj_set_x(ui_Mon, 44);
    lv_obj_set_y(ui_Mon, -75);
    ...
    lv_obj_set_x(ui_AD5940, -30);
    lv_obj_set_y(ui_AD5940, -120);
    lv_obj_set_align(ui_AD5940, LV_ALIGN_CENTER);
    lv_label_set_text(ui_AD5940, "AD5940 Initializing...");
    lv_obj_set_style_text_font(ui_AD5940, &lv_font_montserrat_14, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_add_flag(ui_AD5940, LV_OBJ_FLAG_HIDDEN);

    ui_AD5940_WarmUp = lv_label_create(ui_Home);
    lv_obj_set_width(ui_AD5940_WarmUp, LV_SIZE_CONTENT);  /// 1
    lv_obj_set_height(ui_AD5940_WarmUp, LV_SIZE_CONTENT); /// 1
    lv_obj_set_x(ui_AD5940_WarmUp, -30);
    lv_obj_set_y(ui_AD5940_WarmUp, -120);
    lv_obj_set_align(ui_AD5940_WarmUp, LV_ALIGN_CENTER);
    lv_label_set_text(ui_AD5940_WarmUp, "AD5940 Warm Up...");
    lv_obj_set_style_text_font(ui_AD5940_WarmUp, &lv_font_montserrat_14, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_add_flag(ui_AD5940_WarmUp, LV_OBJ_FLAG_HIDDEN);

    ui_ArcHr = lv_arc_create(ui_Home);
    lv_obj_set_width(ui_ArcHr, 56);
    lv_obj_set_height(ui_ArcHr, 56);
    lv_obj_set_x(ui_ArcHr, -75);
    lv_obj_set_y(ui_ArcHr, 92);
    ...
    lv_obj_set_style_arc_width(ui_ArcHr, 6, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_arc_width(ui_ArcHr, 6, LV_PART_INDICATOR | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_ArcStep, 56);
    lv_obj_set_height(ui_ArcStep, 56);
    lv_obj_set_x(ui_ArcStep, -8);
    lv_obj_set_y(ui_ArcStep, 92);
    ...
    lv_obj_set_style_arc_width(ui_ArcStep, 6, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_arc_width(ui_ArcStep, 6, LV_PART_INDICATOR | LV_STATE_DEFAULT);
    ...
    lv_obj_set_width(ui_ArcMental, 56);
    lv_obj_set_height(ui_ArcMental, 56);
    lv_obj_set_x(ui_ArcMental, 60);
    lv_obj_set_y(ui_ArcMental, 92);
    ...
    lv_obj_set_style_arc_width(ui_ArcMental, 6, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_arc_width(ui_ArcMental, 6, LV_PART_INDICATOR | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_LabelHR, -75);
    lv_obj_set_y(ui_LabelHR, 92);
    lv_obj_set_align(ui_LabelHR, LV_ALIGN_CENTER);
    lv_label_set_text(ui_LabelHR, "85");
    lv_obj_set_style_text_font(ui_LabelHR, &lv_font_montserrat_22, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    ui_ImageTouchLock = lv_img_create(ui_Home);
    lv_obj_set_style_text_font(ui_ImageTouchLock, &ui_font_lock, LV_PART_MAIN);
    lv_img_set_src(ui_ImageTouchLock, MY_SYMBOL_HOMELOCK);
    lv_obj_set_width(ui_ImageTouchLock, LV_SIZE_CONTENT); /// 28
    lv_obj_set_height(ui_ImageTouchLock, LV_SIZE_CONTENT); /// 28
    lv_obj_set_x(ui_ImageTouchLock, -25);
    lv_obj_set_y(ui_ImageTouchLock, -134);
    lv_obj_set_align(ui_ImageTouchLock, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_ImageTouchLock, LV_OBJ_FLAG_HIDDEN); /// Flags
    lv_obj_clear_flag(ui_ImageTouchLock, LV_OBJ_FLAG_SCROLLABLE); /// Flags
    lv_obj_set_style_transform_zoom(ui_ImageTouchLock, 165, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_ImageWifi, 64);
    lv_obj_set_y(ui_ImageWifi, -131);
    ...
    lv_obj_set_style_transform_zoom(ui_ImageWifi, 165, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_ImageWifiOff, 64);
    lv_obj_set_y(ui_ImageWifiOff, -131);
    ...
    lv_obj_set_style_transform_zoom(ui_ImageWifiOff, 165, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_ImageBle, 46);
    lv_obj_set_y(ui_ImageBle, -130);
    ...
    lv_obj_set_style_transform_zoom(ui_ImageBle, 175, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_ImageBleOff, 46);
    lv_obj_set_y(ui_ImageBleOff, -130);
    ...
    lv_obj_set_style_transform_zoom(ui_ImageBleOff, 175, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_LabelBat = lv_label_create(ui_Home);
    lv_obj_set_width(ui_LabelBat, 100);       /// 1
    lv_obj_set_height(ui_LabelBat, 25); /// 1
    lv_obj_set_x(ui_LabelBat, 35);
    lv_obj_set_y(ui_LabelBat, -132);
    lv_obj_set_align(ui_LabelBat, LV_ALIGN_CENTER);
    lv_label_set_text(ui_LabelBat, "--%");
    lv_obj_set_style_text_font(ui_LabelBat, &lv_font_montserrat_14, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_ImageFootStep, -8);
    lv_obj_set_y(ui_ImageFootStep, 118);
    ...
    lv_obj_set_x(ui_stepCntLabel, -8);
    lv_obj_set_y(ui_stepCntLabel, 92);
    ...
    lv_obj_set_x(ui_ImageHR, -75);
    lv_obj_set_y(ui_ImageHR, 118);
    ...
    lv_obj_set_x(ui_ImageMental, 60);
    lv_obj_set_y(ui_ImageMental, 118);
    ...
    lv_obj_set_x(ui_ImageStress, 60);
    lv_obj_set_y(ui_ImageStress, 92);
    ...
    lv_obj_set_x(ui_ImageNeutral, 60);
    lv_obj_set_y(ui_ImageNeutral, 92);
    ...
    lv_obj_set_x(ui_WeatherImage, -88);
    lv_obj_set_y(ui_WeatherImage, 11);
    ...
    lv_obj_set_x(ui_ImageLocation, -94);
    lv_obj_set_y(ui_ImageLocation, -28);
    ...
    lv_obj_set_x(ui_WeatherLabel1, -41);
    lv_obj_set_y(ui_WeatherLabel1, -3);
    ...
    lv_obj_set_x(ui_WeatherLabel2, -38);
    lv_obj_set_y(ui_WeatherLabel2, 19);
    ...
    lv_obj_set_x(ui_LabelCity, -36);
    lv_obj_set_y(ui_LabelCity, -28);
...
void ui_UpdateTouchLock(bool isTouchLocked){
    if(isTouchLocked){
        lv_obj_clear_flag(ui_ImageTouchLock, LV_OBJ_FLAG_HIDDEN); /// Flags
    } else {
        lv_obj_add_flag(ui_ImageTouchLock, LV_OBJ_FLAG_HIDDEN); /// Flags
    }
}
...
void ui_UpdateWeekLabel(uint8_t week)
{
    switch (week) {
        case 1:
            lv_label_set_text(ui_Weekday, "Mon");
            break;
        case 2:
            lv_label_set_text(ui_Weekday, "Tues");
            break;
        case 3:
            lv_label_set_text(ui_Weekday, "Wed");
            break;
        case 4:
            lv_label_set_text(ui_Weekday, "Thur");
            break;
        case 5:
            lv_label_set_text(ui_Weekday, "Fri");
            break;
        case 6:
            lv_label_set_text(ui_Weekday, "Sat");
            break;
        case 0:
            lv_label_set_text(ui_Weekday, "Sun");
            break;
...
void ui_updateBat(uint8_t batValue)
{
    ...
    sprintf(bat, "%d %%", batValue);
    lv_label_set_text(ui_LabelBat, bat);
    if(batValue <= 15){
        lv_obj_set_style_text_color(ui_LabelBat, lv_color_hex(0x800020), LV_PART_MAIN | LV_STATE_DEFAULT);
    } 
    // else {
    //     lv_obj_set_style_text_color(ui_LabelBat, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    // }
...
{
    if (batColor == 1) { // Charging
        lv_obj_set_style_text_color(ui_LabelBat, lv_color_hex(0x6BF7AA), LV_PART_MAIN | LV_STATE_DEFAULT);
    } else if (batColor == 2) {
        if(batValue >= 15)
        {
            lv_obj_set_style_text_color(ui_LabelBat, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
...
void ui_back2home(){
    if(lv_scr_act() != ui_Home){
        _ui_screen_change(ui_Home, LV_SCR_LOAD_ANIM_FADE_IN, 250, 0);
    }
}